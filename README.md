...
There are many section in this code.  There are 3 main section subsections for the different parts of the study

1.	Section #1- data gathering an preparation
...
•	Testing of al features on the logistic regression and CNN model
